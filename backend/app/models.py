...
class Settings(SQLModel, table=True):
    ...
    # The single switch for ad avoidance. When on, an ad break is covered by a
    # clean copy of the same stream on another Twitch player type, and held on a
    # black segment while one is being found - see services.adblock. When off,
    # the upstream playlist is passed through untouched, ads included.
    strip_ads: bool = True
